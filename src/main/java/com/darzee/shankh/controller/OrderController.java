...
public class OrderController {
    ...
    @CrossOrigin
    public ResponseEntity getOrderDetails(@PathVariable("id") Long boutiqueOrderId, @RequestParam("boutique_id") Long boutiqueId) throws Exception {
    ...
    @CrossOrigin
    public ResponseEntity confirmOrder(@PathVariable("id") Long boutiqueOrderId, @RequestParam("boutique_id") Long boutiqueId, @Validated(OrderCreationRequest.ConfirmOrder.class) @RequestBody OrderCreationRequest request) throws Exception {
    ...
    @CrossOrigin
    public ResponseEntity getInvoiceDetail(@PathVariable("id") Long boutiqueOrderId, @RequestParam("boutique_id") Long boutiqueId) {
