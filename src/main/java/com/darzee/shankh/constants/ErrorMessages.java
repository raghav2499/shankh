...
public class ErrorMessages {
    ...
    public static String CUSTOMER_ALREADY_REGISTERED_ERROR_MSG="Customer already registered";
    ...
    public static String INVALID_CUSTOMER_ID_OR_BOUTIQUE_ID_ERROR  ="Invalid customer id or boutique id";
   public static String INVALID_BOUTIQUE_ID_AND_CUSTOMER_ID =" Boutique ID and customer ID are mandatory fields";
    public static String MANDATORY_FIELDS_MISSING ="Some mandatory fields in order are missing.";
    public static String INVALID_PRICE_BREAKUP ="Items' Price Breakups are not summing up to total amount. ";
    public static String INVALID_PRICE_BREAKUP_SUM =" and price break up sum ";
    public static String INVALID_AMOUNT_RECEIVED ="Amount recieved is greater than pending order amount. Amount Received : ";
    public static String INVALID_PENDING_AMOUNT_RECEIVED=" Pending Amount : ";
    ...
    public static String REFUND_GREATER_THAN_ORDER_CHANGE ="Amount refund could not be greater than order amount change. ";
    public static String ORDER_AMOUNT_CHANGED  ="Order Amount changed by ";
    public static String REFUND_NOT_ALLOWED =" and we cannot refund ";
