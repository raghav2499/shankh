...
public class Constants {
    ...
    public static final List<OrderItemStatus> ACTIVE_ORDER_STATUS_LIST =
            Arrays.asList(OrderItemStatus.ACCEPTED, OrderItemStatus.UNDER_CUTTING, OrderItemStatus.UNDER_FINISHING,
                    OrderItemStatus.UNDER_STITCHING, OrderItemStatus.COMPLETED);

    public static final List<OrderItemStatus> CLOSED_ORDER_STATUS_LIST = Arrays.asList(OrderItemStatus.DELIVERED);
