...
public class OrderItemStateMachineService {
    ...
    Map<OrderItemStatus, List<OrderItemStatus>> validStateTransitions = new HashMap<OrderItemStatus, List<OrderItemStatus>>() {{
        ...
        put(OrderItemStatus.ACCEPTED, Arrays.asList(OrderItemStatus.UNDER_CUTTING, OrderItemStatus.UNDER_STITCHING, OrderItemStatus.UNDER_FINISHING));
        put(OrderItemStatus.UNDER_CUTTING, Arrays.asList(OrderItemStatus.ACCEPTED, OrderItemStatus.UNDER_STITCHING, OrderItemStatus.UNDER_FINISHING));
        put(OrderItemStatus.UNDER_STITCHING, Arrays.asList(OrderItemStatus.ACCEPTED, OrderItemStatus.UNDER_CUTTING, OrderItemStatus.UNDER_FINISHING));
        put(OrderItemStatus.UNDER_FINISHING, Arrays.asList(OrderItemStatus.ACCEPTED, OrderItemStatus.UNDER_CUTTING, OrderItemStatus.UNDER_FINISHING));
